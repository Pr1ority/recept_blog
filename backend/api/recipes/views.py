...
class RecipeViewSet(viewsets.ModelViewSet):
    ...
    def unfavorite(self, request, pk=None):
        ...
        return Response({'status': 'рецепт не находится в избранном'}, status=status.HTTP_400_BAD_REQUEST)
    ...
    def remove_from_cart(self, request, pk=None):
        ...
        return Response({'status': 'рецепт не в списке покупок'}, status=status.HTTP_400_BAD_REQUEST)
